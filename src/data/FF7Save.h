 ...
 *  \todo Add support for ps4 format, Requires decrypting exported save data.
...
public:
    ...
    enum WORLDVEHICLE {
        WVEHCILE_BUGGY = 0 /**< 0*/
        , WVEHCILE_TBRONCO = 2 /**< 2*/
        , WVEHCILE_HIGHWIND = 4 /**< 4*/
    };
    Q_ENUM(WORLDVEHICLE)
     ...
     */
    enum PSXBLOCKTYPE {
        BLOCK_EMPTY = 0xA0 /**< 0xA0*/
        , BLOCK_MAIN = 0x51 /**< 0x51*/
        , BLOCK_DELETED_MAIN = 0xA1 /**< 0xA1*/
        , BLOCK_MIDLINK = 0x52 /**< 0x52*/
        , BLOCK_DELETED_MIDLINK = 0xA2 /**< 0xA2*/
        , BLOCK_ENDLINK = 0x53 /**< 0x53*/
        , BLOCK_DELETED_ENDLINK = 0xA3, /**< 0xA3*/
    };
    Q_ENUM(PSXBLOCKTYPE)
    /*! \enum KEYITEMS
     ...
     */
    enum KEYITEMS {
        COTTONDRESS/**< 0*/, SATINDRESS/**< 1*/, SILKDRESS/**< 2*/, WIG/**< 3*/, DYEDWIG/**< 4*/, BLONDEWIG/**< 5*/, GLASSTIARA/**< 6*/, RUBYTIATA/**< 7*/, DIAMONDTIARA/**< 8*/, COLOGNE/**< 9*/
        , FLOWERCOLOGNE/**< 10*/, SEXYCOLOGNE/**< 11*/, MEMBERSCARD/**< 12*/, LINGERIE/**< 13*/, MYSTERYPANTIES/**< 14*/, BIKINIBRIEFS/**< 15*/, PHARMACYCOUPON/**< 16*/, DISINFECTANT/**< 17*/, DEODORANT/**< 18*/, DIGESTIVE /**< 19*/
        , HUGEMATERIA_CONDOR/**< 20*/, HUGEMATERIA_COREL/**< 21*/, HUGEMATERIA_UNDERWATER/**< 22*/, HUGEMATERIA_ROCKET/**< 23*/, KEYTOANCIENTS/**< 24*/, LETTERTOADAUGHTER/**< 25*/, LETTERTOAWIFE/**< 26*/, LUNARHARP/**< 27*/, BASEMENTKEY/**< 28*/, KEYTOSECTOR5/**< 29*/
        , KEYCARD60/**< 30*/, KEYCARD62/**< 31*/, KEYCARD65/**< 32*/, KEYCARD66/**< 33*/, KEYCARD68/**< 34*/, MIDGARPARTS1/**< 35*/, MIDGARPARTS2/**< 36*/, MIDGARPARTS3/**< 37*/, MIDGARPARTS4/**< 38*/, MIDGARPARTS5/**< 39*/
        , PHS/**< 40*/, GOLDTICKET/**< 41*/, KEYSTONE/**< 42*/, LEIATHANSCALES/**< 43*/, GLACIERMAP/**< 44*/, COUPON_A/**< 45*/, COUPON_B/**< 46*/, COUPON_C/**< 47*/, BLACKMATERIA/**< 48*/, MYTHRIL/**< 49*/
        , SNOWBOARD/**< 50*/
    };
    Q_ENUM(KEYITEMS)

    //Functions
    FF7Save(QObject *parent = nullptr); /**< \brief create a new FF7Save object */
    ~FF7Save() = default;
    ...
    *  \param fileName file that will be saved
    *  \param newFormat FF7Save::FORMAT of file to be saved
    *  \param s Slot to export if exporting to a multi slot save type
    *  \return True if Successful
    *  \sa exportPC(),exportPSX(),exportVMC(),exportDEX(),exportVGS()
    */
    bool exportFile(const QString &fileName, FF7Save::FORMAT newFormat, int s = 0);
    ...
    */
    void importSlot(int s = 0, const QString &fileName = nullptr, int fileSlot = 0);
     ...
     */
    void newGame(int s, const QString &fileName = nullptr); //new game in slot s (over load default w/ fileName must be RAW PSX)
     ...
     * \param fileName Raw PSX file to use instead of defalut data
     */
    void newGamePlus(int s, const QString &CharFileName, const QString &fileName);//new game + in slot s (over load default w/ fileName must be RAW PSX
    ...
    */
     ...
     */
    qint16 craterSavePointMapID(int s);
    ...
    */
    ...
    //Mini Game Stuff
    qint8 love(int s, bool battle, LOVER who);
    void setLove(int s, bool battle, LOVER who, qint8 love);
    ...
    FF7Save::FORMAT format(void);// Returns the file type loaded.
    ...
    void setFormat(FF7Save::FORMAT);//allows for slot change.
    ...
    */
    ...
    inline void setPs3Key(const QByteArray &key)
    {
        PS3Key = key;
    }
    inline void setPs3Seed(const QByteArray &seed)
    {
        PS3Seed = seed;
    }
    inline const QByteArray &ps3Key(void)
    {
        return PS3Key;
    }
    inline const QByteArray &ps3Seed(void)
    {
        return PS3Seed;
    }
signals:
...
private:
    ...
    quint8 *file_headerp = nullptr; //pointer to file header
    quint8 *file_footerp = nullptr; //pointer to file footer
    ...
    FF7TEXT *Text = nullptr;
    bool fileHasChanged = false;
    bool slotChanged[15];
    FF7Save::FORMAT SG_FORMAT = FF7Save::FORMAT::UNKNOWN;
    int SG_SIZE = 0;
    int SG_HEADER = 0;
    int SG_FOOTER = 0;
    int SG_SLOT_HEADER = 0;
    int SG_SLOT_FOOTER = 0;
    int SG_SLOT_SIZE = 0;
    int SG_SLOT_NUMBER = 0;
    //private functions
